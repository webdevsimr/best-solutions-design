    ...
    return (
        <div className="ProductSolutionBoxLeft">
            <div className="ProductSolutionsBox_left_text">
                ...
                <div className="ProductSolutionsBox_left_Img">
...
export default ProductSolutionBoxLeft;
